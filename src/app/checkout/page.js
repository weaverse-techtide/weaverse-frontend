          ...
          <div className="row g-4 g-sm-5">
            ...
            <div className="col-xl-8 mb-4 mb-sm-0">
              ...
              <div className="card card-body shadow p-4">
                  ...
                  <div className="col-12">
                    ...
                    <div className="row g-2">
                      ...
                      <div className="col-2 col-sm-1 border rounded me-2">
                        <a href="#">
                          <Image
                            src="/assets/images/client/ae-card.svg"
                            alt=""
                            height={100}
                            width={100}
                          />
                ...
                <div className="row g-3 mt-4">
                  ...
                  <div className="col-12">
                    <div
                      className="accordion accordion-circle"
                      id="accordioncircle"
                    >
            ...
            <div className="col-xl-4">
              <div className="row mb-0">
                  ...
                  <div className="card card-body shadow p-4 mb-4">
                    ...
                    <div className="row g-3">
                      ...
                      <div className="col-sm-8">
                        <h6 className="mb-0">
                          <a href="#">
                            Sketch from A to Z: for an app designer
                          </a>
                        </h6>
                        {/* Info */}
                ...
                <div className="col-md-6 col-xl-12">
                  <div
                    className="card bg-blue p-3 position-relative overflow-hidden"
                  ...
                  >
                    ...
                    <div className="card-body">
                      ...
                      <h5 className="card-title text-white mb-2">
                        Access 25K Online courses from 120 institutions, Start
                        today!
                      </h5>
                      <p className="text-white text-opacity-75">
                        Here is the description of premium features which will
                        allow users to get benefits and save a lot of money
                      </p>
                      {/* Button */}
