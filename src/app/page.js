      ...
      <section>
        <div className="container">
            ...
            {mainCategories.map((category, index) => (
              <li className="nav-item me-2 me-sm-5" key={index}>
                <button
                  ...
                  id={`course-pills-tab-${index + 1}`}
                  data-bs-toggle="pill"
                  data-bs-target={`#course-pills-tabs-${index + 1}`}
                  type="button"
                  role="tab"
                  aria-controls={`course-pills-tabs-${index + 1}`}
                  aria-selected="false"
                >
                  {category}
                </button>
          ...
          <div className="tab-content" id="course-pills-tabContent">
            ...
            >
              <div className="row g-4">
                {pythonCourses.results.map((course, index) => (
            ...
            >
              <div className="row g-4">
                {/* Card item START */}
                {jsCourses.results.map((course, index) => (
                  <div className="col-sm-6 col-lg-4 col-xl-3" key={index}>
                    <div className="card shadow h-100">
                      {/* Image */}
                      <Image
            ...
            >
              <div className="row g-4">
                {/* Card item START */}
                {djangoCourses.results.map((course, index) => (
                  <div className="col-sm-6 col-lg-4 col-xl-3" key={index}>
                    <div className="card shadow h-100">
                      {/* Image */}
                      <Image
            ...
            >
              <div className="row g-4">
                {/* Card item START */}
                {reactCourses.results.map((course, index) => (
                  <div className="col-sm-6 col-lg-4 col-xl-3" key={index}>
                    <div className="card shadow h-100">
                      {/* Image */}
                      <Image
            ...
            >
              <div className="row g-4">
                {/* Card item START */}
                {awsCourses.results.map((course, index) => (
                  <div className="col-sm-6 col-lg-4 col-xl-3" key={index}>
                    <div className="card shadow h-100">
                      {/* Image */}
                      <Image
                      ...
                      <div className="d-flex justify-content-between mb-2">
                        <div className="hstack gap-2">
                          <p className="text-warning m-0">
                            4.5<i className="fas fa-star text-warning ms-1"></i>
                          </p>
                  ...
                  <div className="card action-trigger-hover border bg-transparent">
                    ...
                    <div className="card-body pb-0">
                      ...
                      <div className="d-flex justify-content-between mb-2">
                        <div className="hstack gap-2">
                          <p className="text-warning m-0">
                            4.0<i className="fas fa-star text-warning ms-1"></i>
                          </p>
