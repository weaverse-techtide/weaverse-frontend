                ...
                <div className="col-sm-6 col-lg-4 col-xl-3">
                  <div className="card shadow h-100">
                    ...
                    <div className="card-footer pt-0 pb-3">
                      ...
                      <div className="d-flex justify-content-between">
                        <span className="h6 fw-light mb-0">
                          <i className="far fa-clock text-danger me-2"></i>35h
                          20m
                        </span>
                        <span className="h6 fw-light mb-0">
                          <i className="fas fa-table text-orange me-2"></i>89
                          lectures
                        </span>
                      </div>
                    </div>
                ...
                <div className="col-sm-6 col-lg-4 col-xl-3">
                  <div className="card shadow h-100">
                    ...
                    <div className="card-footer pt-0 pb-3">
                      ...
                      <div className="d-flex justify-content-between">
                        <span className="h6 fw-light mb-0">
                          <i className="far fa-clock text-danger me-2"></i>21h
                          22m
                        </span>
                        <span className="h6 fw-light mb-0">
                          <i className="fas fa-table text-orange me-2"></i>30
                          lectures
                        </span>
                      </div>
                    </div>
