...
export default function CurriculumDetailPage({ params }) {
  return (
    <main>
      {/* =======================
Page intro START */}
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                          ...
                          <p className="mb-0 text-danger">
                            <i className="fas fa-stopwatch me-2"></i>5 days left
                            at this price
                          </p>
                        </div>
                  ...
                  <div className="card p-2 border">
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        ...
                        >
                          <i className="fas fa-circle small fw-bold me-2"></i>
                ...
                <div className="pb-4">
                  <div className="card p-2 border">
                    ...
                    <div className="card-body">
                      ...
                      {/* Title */}
                      <h5 className="card-title">
                        <a href="#">Google Ads Training: Become a PPC Expert</a>
                      </h5>
                      {/* Badge and Price */}
                      <div className="d-flex justify-content-between align-items-center">
                        <a
                ...
                <div className="pb-4">
                  <div className="card p-2 border">
                    ...
                    <div className="card-body">
                      ...
                      {/* Title */}
                      <h5 className="card-title">
                        <a href="#">Behavior, Psychology and Care Training</a>
                      </h5>
                      {/* Badge and Price */}
                      <div className="d-flex justify-content-between align-items-center">
                        <a
